...
void l1tcheck()
{
  ...
  else
  {
    if (a1 == 1)
    {
      if (pt1 == 2 || pt1 == 3 || pt1 == 4)
      {
        if (pt2 == 2 || pt2 == 3 || pt2 == 4)
        {
          if (pt3 == 2 || pt3 == 3 || pt3 == 4)
          {
            pt4=1;
          }
          else
...
void l2tcheck()
{
  ...
  else
  {
    if (b1 == 1)
    {
      if (pt1 == 1 || pt1 == 3 || pt1 == 4)
      {
        if (pt2 == 1 || pt2 == 3 || pt2 == 4)
        {
          if (pt3 == 1 || pt3 == 3 || pt3 == 4)
          {
            pt4=2;
          }
          else
...
void l3tcheck()
{
  ...
  else
  {
    if (c1 == 1)
    {
      if (pt1 == 2 || pt1 == 1 || pt1 == 4)
      {
        if (pt2 == 2 || pt2 == 1 || pt2 == 4)
        {
          if (pt3 == 2 || pt3 == 1 || pt3 == 4)
          {
            pt4=3;
          }
          else
...
void l4tcheck()
{
  ...
  else
  {
    if (d1 == 1)
    {
      if (pt1 == 2 || pt1 == 3 || pt1 == 1)
      {
        if (pt2 == 2 || pt2 == 3 || pt2 == 1)
        {
          if (pt3 == 2 || pt3 == 3 || pt3 == 1)
          {
            pt4=4;
          }
          else
